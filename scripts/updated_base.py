...
class AttributeDict(UserDict):
    ...
    def __setattr__(self, key, value):
        if key == "data":  # this is to avoid overwriting the inner data dict of UserDict
...
class CareFixtureBase:
    ...
    def add_user_to_facility_organization(self, facility_id, facility_organization_id, user_id, role_id):
        url = reverse(
    ...
    def create_patient(self, geo_organization, **kwargs):
        data = {
            ...
            "blood_group": choice([b.value for b in BloodGroupChoices if b.value != "unknown"]),
            **kwargs,
        }
    ...
    def create_encounter(self, patient_id, facility_id, organizations=None, **kwargs):
        data = {
            ...
            "status": choice([s.value for s in EncounterStatusChoices if s.value != "unknown"]),
    ...
    def load_questionnaires_from_file(self, organizations, path="data/questionnaire_fixtures.json"):
    ...
    def create_charge_item_definition(self, facility_id, title, price_components, **kwargs):
        url = reverse(
    ...
    def create_request_order(self, facility_id, name, destination, **kwargs):
        url = reverse("request-order-list", kwargs={"facility_external_id": facility_id})
        data = {
            "status": "pending",
            "name": name,
    ...
    def create_delivery_order(self, facility_id, name, destination, **kwargs):
        url = reverse("delivery-order-list", kwargs={"facility_external_id": facility_id})
        data = {
            "status": "pending",
            "name": name,
            "destination": destination,
    ...
    def create_lab_test(
        ...
        observation = self.create_observation_definition(facility=facility_id, **test["observation"])
    ...
    def create_token_sub_queue(self, facility_id, resource_type, resource_id, **kwargs):
        url = reverse("token-sub-queue-list", kwargs={"facility_external_id": facility_id})
        data = {
    ...
    def create_token_category(self, facility_id, resource_type, **kwargs):
        url = reverse("token-category-list", kwargs={"facility_external_id": facility_id})
        data = {
    ...
    def load_templates_from_file(self, facility=None, path="data/template_fixtures.json"):
        fixture_path = Path(path)
        if not fixture_path.exists():
            return []
        with fixture_path.open() as f:
    ...
    def create_medication_administration(self, patient_id, encounter_id, medication, request_id=None, **kwargs):
        ...
        data = {
            ...
            "status": "completed",
            "medication": medication,
            "occurrence_period_start": now.isoformat(),
    ...
    def apply_activity_definition_as_service_request(
        self,
        facility_id,
        encounter_id,
        ...
        **kwargs,
        ...
        facility_obj = Facility.objects.get(external_id=facility_id)
        ad = ActivityDefinition.objects.get(
            slug=activity_definition_slug,
        ...
        data = {
            "encounter": encounter_id,
            "title": kwargs.pop("title", ad.title),
            "status": kwargs.pop("status", "active"),
            "intent": kwargs.pop("intent", "order"),
            "priority": kwargs.pop("priority", "routine"),
            "category": ad.classification,
            "do_not_perform": kwargs.pop("do_not_perform", False),
            "code": ad.code,
            "locations": kwargs.pop("locations", []),
            **kwargs,
        }
    ...
    def create_diagnostic_report(
        ...
        **kwargs,
        ...
        data = {
            ...
            "status": kwargs.pop("status", "preliminary"),
            "conclusion": kwargs.pop("conclusion", ""),
            "category": kwargs.pop(
                "category",
                {
                    "code": "LAB",
